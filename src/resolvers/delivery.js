...
exports.default = {
    ...
    Delivery: {
        message: (parent, _args, context) => translateDeliveryMessage(parent, context),
    },
    OrderDeliveryState: {
        message: (parent, _args, context) => translateDeliveryMessage(parent, context),
    },
